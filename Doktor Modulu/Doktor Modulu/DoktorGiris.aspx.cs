...
namespace Doktor_Modulu
{
    public partial class DoktorGiris : System.Web.UI.Page
    {
        ...
        {
            Hastane.Open();
            SqlCommand Doktor_Kullanici_Adi = new SqlCommand("Select Doktor_Kullanici_Adi from Doktor_Tanim", Hastane);
            SqlDataReader Kullanici_Adi_Oku = Doktor_Kullanici_Adi.ExecuteReader();
            ...
            Hastane.Open();
            SqlCommand Doktor_Sifre = new SqlCommand("Select Doktor_Sifre from Doktor_Tanim", Hastane);
            SqlDataReader Sifre_Oku = Doktor_Sifre.ExecuteReader();
